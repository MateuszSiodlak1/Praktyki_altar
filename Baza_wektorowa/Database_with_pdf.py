...
# Ścieżka, w której Qdrant utworzy lokalną bazę danych
QDRANT_DB_PATH = os.path.join(BASE_DIR, "qdrant_db")

MODEL_NAME = "xlm-roberta-base-ViT-B-32"
PRETRAINED = "laion5b_s13b_b90k"
REPRESENTATION_TYPE = "FixRes"  # Standardowy preprocessing OpenCLIP (skalowanie do 224x224)

ALLOWED_SUBFOLDERS = ["app_screenshots", "charts", "pdf_files", "photos"]


def load_image_or_pdf(file_path):
    """Wczytuje plik JPG/PNG lub renderuje pierwszą stronę pliku PDF."""
...
def main():
    ...
    print(
        f"Znaleziono {len(image_paths_map)} plików do zindeksowania "
